...
const EditBlog = () => {
  ...
  const fetchBlog = async () => {
    try {
      ...
      setValue('tags', blogData.tags ? blogData.tags.map(tag => tag.name).join(', ') : '');
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await blogService.updateBlog(slug, blogData);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mt-4">Edit Blog</h1>
